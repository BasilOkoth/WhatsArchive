...
public class WhatsAppNotificationListener extends NotificationListenerService {
    public static final String ACTION_ARCHIVE_UPDATED =
            "com.elimara.chatarchive.ARCHIVE_UPDATED";
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        // Free and Pro users can capture incoming WhatsApp notifications.
    ...
    private void store(
        ...
        if (id > 0) {
            ArchiveAttachment attachment = AttachmentCapture.capture(
                    this,
                    sourceMessageBundle,
                    id,
                    postedAt
            ...
            if (attachment != null) {
                db.insertAttachment(id, attachment);
            }
